...
* Utilized Python in conjunction with SQL, to create a predictive linear regression model for net charge-offs. The implementation led to substantial enhancements in prediction accuracy and a marked reduction in forecasting errors.
